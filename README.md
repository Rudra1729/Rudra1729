...
📫 Reach me: [rudrapatel@umass.edu](mailto:rudrapatel@umass.edu) • [LinkedIn](https://linkedin.com/in/rudra-patel-9440431ba)

---

### 🧠 What I'm Working On

**DS4CG — UMass Dept. of Data Science and AI** *(Jun 2026 – Present)*
...
**Mechanistic Interpretability on Time Series Models — Minuteman Alternative Investment Fund** *(Jan – Present)*
...
- Deployed Ridge linear probes to decode Black-Scholes greeks from hidden layers (peak R² of 0.79 for delta).

---

### 🚀 Featured Projects

**[OceanEye](https://github.com/Rudra1729) — Autonomous Underwater Waste Segmentation**
🏆 HackUMass 2025 Winner, Best Sustainability Hack
...
**[Nidaan AI](https://github.com/Rudra1729) — On-Device Rural Healthcare Assistant**
...
**ML/AI:** Hugging Face Transformers • PyTorch • LangChain • ChromaDB • DVC • RAG • Prompt Engineering • LLM Fine-Tuning
**Languages:** Python • Java • C++ • C • SQL • JavaScript • TypeScript
**Infra/Tools:** Git & GitHub • Google Cloud Run • Flask • Flask-SocketIO • React • JUnit

---

### 🎓 Education
**B.S. Computer Science, Honors College** — University of Massachusetts Amherst *(GPA: 4.00)*
**Machine Learning Foundations** — Cornell University (online certificate, in progress)

---

<sub>⚡ Currently exploring: interpretability research and efficient fine-tuning of small language models.</sub>
